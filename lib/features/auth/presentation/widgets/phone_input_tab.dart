...
class PhoneInputTab extends ConsumerStatefulWidget {
  const PhoneInputTab({super.key});

  @override
  ConsumerState<PhoneInputTab> createState() => _PhoneInputTabState();
}

class _PhoneInputTabState extends ConsumerState<PhoneInputTab> {
  ...
  void _submit() {
    ref
        ...
        .requestPhoneOtp(_controller.text);
  }
}
