...
android {
    namespace = "com.rathtech.securechat"
    ...
    defaultConfig {
        applicationId = "com.rathtech.securechat"
    ...
    buildTypes {
        release {
            ...
            // Use release keys when key.properties exists; fall back to debug
            // keys only for local CI runs where signing is not configured.
